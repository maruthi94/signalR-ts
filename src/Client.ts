...
export default class Client extends EventEmitter {
  ...
  start(options: any) {
    ...
    if (this.state !== CLIENT_STATES.stopped) {
      ...
      throw new Error(
        'The SignalR client is in an invalid state. You only need to call `start()` once and it cannot be called while reconnecting.'
      );
    }
   ...
   * @returns {void} Nothing is returned by this method.
   */
  stateChanging(callback: Function) {
   ...
   * @returns {void} Nothing is returned by this method.
   */
  disconnecting(callback: Function) {
   ...
   * @returns {void} Nothing is returned by this method.
   */
  reconnecting(callback: Function) {
   ...
   * @returns {void} Nothing is returned by this method.
   */
  connectionSlow(callback: Function) {
