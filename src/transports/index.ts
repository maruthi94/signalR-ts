...
export function AvailableTransports() {
  ...
  return [WebSocketTransport, ServerSentEventsTransport, LongPollingTransport, NullTransport];
}

// export function transportFactory(type: string, client: any, treaty: any, url: string) {
//   switch (type) {
//     case 'WebSocketTransport':
//       return new WebSocketTransport(client, treaty, url);
//     case 'ServerSentEventsTransport':
//       return new ServerSentEventsTransport(client, treaty, url);
//     case 'LongPollingTransport':
//       return new LongPollingTransport(client, treaty, url);
//     case 'NullTransport':
//       return new NullTransport(client, treaty);
//   }
// }
